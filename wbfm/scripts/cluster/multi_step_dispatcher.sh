...
#
# Example 2 (use manual annotation or somehow modified tracklets to build tracking, and recalculate traces):
# bash multi_step_dispatcher.sh -s 3b -s 4 -t '/scratch/neurobiology/zimmer/Charles/dlc_stacks/manually_annotated/paper_data/ZIM2165_Gcamp7b_worm1-2022_11_28/project_config.yaml'
