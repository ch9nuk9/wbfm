...
rule dlc_analyze_videos:
    ...
    shell:
        ...
        python -c "import deeplabcut, os; fname = deeplabcut.analyze_videos('{params.dlc_model_configfile_path}', '{input.input_avi}', videotype='avi', gputouse=0, save_as_csv=True); print('Produced raw files with name: ' + fname); os.rename(f'{output_behavior_dir}'+fname+'.h5', '{output_behavior_dir}/raw_stack_dlc.h5'); os.rename(f'{output_behavior_dir}'+fname+'.csv', '{output_behavior_dir}/raw_stack_dlc.csv')"
        """
